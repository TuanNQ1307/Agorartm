...
$(() => {
  ...
  $("#login").on("click", function (e) {
    ...
    // validate get appId & accountName
    ...
    try {
      // createinstance client and subcriteclient event 
  ...
  $("#join").on("click", function (e) {
    ...
    // get values in form set to param 
    const params = serializeFormData("loginForm");
  ...
  $("#send_channel_message").on("click", function (e) {
    ...
    // get value in form set new array
    const params = serializeFormData("loginForm");
    ...
    rtm.sendChannelMessage(params.channelMessage, params.channelName).then(() => {
      console.log("check element in params", params);
      var view = "";      
      if(params.memberId != ""){
        view = $("<div/>", {
          tes:"<div style= 'float:right;'>" + rtm.accountName + " : " + params.channelMessage +"</div>"
             
        });
      }else{
        view = $("<div/>", {
        html:"<div>" + rtm.accountName + " : " + params.channelMessage +"</div>"
